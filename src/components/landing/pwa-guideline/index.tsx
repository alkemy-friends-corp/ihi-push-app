...
export function PWAInstallGuide() {
  ...
  return (
    <Card className="border-2 border-red-200 bg-gradient-to-br from-blue-50 to-indigo-50">
      <CardHeader>
        ...
        {isExpanded && (
          <div className="space-y-3 text-sm">
            <div className="p-3 bg-white rounded-lg border">
              <p className="font-medium mb-2">{t('pwa.iphone')}</p>
            ...
            <div className="p-3 bg-white rounded-lg border">
              <p className="font-medium mb-2">{t('pwa.android')}</p>
              <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
